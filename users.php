...
<div class="container">
        <h2 class="text-center pt-4" style="font-family: sans-serif;"><b>USERS</b></h2>
        <br>
            <div class="row">
                <div class="col">
...
<div  class="nv">
                ...
                <center><a href="index.php" ><button style="width: 70px; height: 50px; border-radius: 12px;"><b>Home</b></button></a></center>
</div>
<br>
</body>
</html>